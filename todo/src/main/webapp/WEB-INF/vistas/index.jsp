...
<main class="my-3 container">
	...
	<ul class="list-unstyled">
		<c:forEach items="${tareas}" var="t">
			<li>
				<form action="modificar-tarea" method="post"
					class="input-group mb-3">
					<input type="hidden" name="id" value="${t.id}">
					<div class="input-group-text">
						<input name="terminada" class="fs-3 form-check-input mt-0"
							type="checkbox" ${t.terminada ? 'checked': ''}>
					</div>
					<input type="text" name="texto"
						class="form-control ${t.terminada ? 'text-decoration-line-through': ''}"
						value="${t.texto}">
